"""네트워크 없이 v8(주요 사이트 우선 검색 + 충분성 판정 + 스킬 문서 기반 부스 컨셉) 로직을 검증하는 오프라인 테스트.
    ...
    if "스킬의 1~4단계" in p:
        ...
        return {"insights": [{"fact": "덜 끈적이는 간식 선호", "insight": "손 더럽히지 않는 한입", "implication": "끈적임 비교 시식",
                ...
                "big_idea": {"line_en": "Honey pastry that won't stick to your fingers", "line_ko": "손에 안 묻는 꿀과자",
                             "why": "강점과 소비자 불만이 맞닿음", "basis": ["기업:강점", "E1"]},
...
class V6PipelineTest(unittest.TestCase):
    ...
    def test_flask_render(self):
        ...
        for text in ["v8 · 주요 사이트 우선 + 스킬 기반 부스 컨셉 기획", "검색 범위", "부스 컨셉 기획안", "1. 메인 비주얼",
