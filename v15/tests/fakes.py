...
def booth_payload(stage):
    ...
    return {
        ...
        "key_actions": [{"title": "흰 장갑 시식으로 끈적임 없음 증명",
                         "detail": "10월 2일까지 운영 담당이 흰 장갑 200켤레와 시식 동선을 확정하고, 첫날 오전 리허설로 10초 안에 시식이 끝나는지 확인하며, 부족한 소모품은 현장 공급처에서 바로 보충할 수 있게 연락처를 준비한다. 근거: R2·R3, 기획.",
                         "basis": ["R2", "기업:강점"]},
        ...
        "visitor_flow": {"3s": {"headline": "흰 장갑 백월로 시선 고정", "goal": "통로 방문객 멈추기",
                         ...
                         "3min": {"headline": "3분: 원페이저 상담", "staff": "케이스 단가·MOQ 안내",
                                  "message": "손에 안 묻는 한입 약과를 케이스 단위로 먼저 시험 판매해 보시고, 매대 회전율을 확인한 뒤 다음 주에 정식 발주 조건과 물류 일정을 함께 확정하시죠."}},
