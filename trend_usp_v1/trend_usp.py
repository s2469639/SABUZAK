...
DEFAULT_LIGHT_MODEL = "gpt-4o-mini"   # 시드·분류·탐색 (.env TREND_USP_MODEL)
DEFAULT_STRATEGY_MODEL = "gpt-4o"     # 시장 맥락·USP·부스 (.env TREND_USP_STRATEGY_MODEL)
...
def _get_openai_client():
    ...
    if _openai_client is None:
        ...
        _openai_client = OpenAI(api_key=api_key, timeout=90, max_retries=2, default_headers=SAFE_HEADERS)
