...
VERSION = "v9.0"               # 질문·프롬프트·규칙을 바꾸면 올려서 리포트 캐시 무효화
MODEL = "gpt-4o-mini"
# v7: 부스 컨셉 기획(초안·검토·수정)만 상위 모델. .env로 바꿀 수 있음
BOOTH_MODEL = os.getenv("TAVILY_BOOTH_MODEL") or "gpt-4o"
CACHE_TTL_DAYS = 30
...
SELF_RESEARCH_MODEL = os.getenv("TAVILY_V9_RESEARCH_MODEL") or BOOTH_MODEL
...
def plan_booth_independent(client, product_name, country, exhibition_name, exhibition_website, profile):
